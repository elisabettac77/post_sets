...
<div class="mh-wrapper mh-clearfix">
    <div id="main-content" class="mh-loop mh-content" role="main">
        ...
        if (!empty($current_post_ids)) {
            ...
            // Build prepare arguments array: query format string first, then values
            $prepare_args = array(
            ...
            // Add post IDs to the prepare args array
            foreach ($current_post_ids as $id_value) {
                $prepare_args[] = $id_value;
            }
